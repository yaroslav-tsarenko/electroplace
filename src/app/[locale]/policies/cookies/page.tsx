...
export const metadata = { title: "Cookie Policy — Electroplace" };

export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="29 May 2026">
      <p>
        This Cookie Policy explains how RYE FLOUR COOKIES LTD, trading as Electroplace, uses cookies and similar
        technologies on www.electroplace.co.uk.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Cookie Policy, &ldquo;Electroplace&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
      ...
      <ul>
        <li>first-party cookies, set directly by Electroplace; or</li>
      ...
      <p>
        8.2 These cookies may be set by Electroplace or by third-party advertising and marketing partners.
      </p>
      <p>
      ...
      <p>9.4 Electroplace does not store your full card number or full card security code.</p>
