...
export const metadata = { title: "Privacy Policy — Electroplace" };

export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="29 May 2026">
      <p>
        This Privacy Policy explains how RYE FLOUR COOKIES LTD, trading as Electroplace, collects, uses, stores, shares,
        and protects personal data when you visit www.electroplace.co.uk, create an account, place an order,
        contact us, use our services, or otherwise interact with us.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Privacy Policy, &ldquo;Electroplace&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
      ...
      <p>3.1 The personal data we collect depends on how you interact with Electroplace.</p>
      ...
      <p>
        ...
        the relevant email or contacting us at info@electroplace.co.uk.
      </p>
      <p>
      ...
      <p>
        11.1 Because Electroplace sells internationally and uses third-party service providers, your personal
      ...
      <p>14.3 To exercise your rights, please contact us at info@electroplace.co.uk.</p>
      ...
      <p>
        ...
        info@electroplace.co.uk so we can try to resolve the matter.
      </p>
      <p>
      ...
      <p>
        ...
        info@electroplace.co.uk and we will take appropriate steps to review and delete the information where
        required.
      </p>
