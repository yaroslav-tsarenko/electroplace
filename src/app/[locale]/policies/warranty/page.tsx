...
export const metadata = { title: "Warranty Policy — Electroplace" };
  ...
  return (
    <PolicyLayout title="Warranty Policy" lastUpdated="29 May 2026">
      <p>
        ...
        paid Additional Warranty options apply to products purchased through www.electroplace.co.uk.
      </p>
      ...
      <p>5.2 Manufacturer warranty terms are set by the manufacturer, not by Electroplace.</p>
      <p>
      ...
      <p>
        5.5 Electroplace may assist with manufacturer warranty claims where reasonable, but we do not control
      ...
      <p>6.1 Electroplace may offer paid Additional Warranty options for selected products.</p>
      ...
      <p>11.1 To make a warranty claim, contact us at info@electroplace.co.uk.</p>
      ...
      <p>
        12.1 Warranty claims may require inspection by Electroplace, the manufacturer, supplier, service
      ...
      <p>
        ...
        may be covered by Electroplace where required by law or approved by us.
      </p>
      <p>
      ...
      <p>
        ...
        law or approved by Electroplace.
      </p>
      <p>
      ...
      <p>
        17.4 To the fullest extent permitted by law, Electroplace will not be liable to Business Customers for
