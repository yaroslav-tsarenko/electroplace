    ...
    <>
      <JsonLd
        data={{
          ...
          alternateName: ["electroplace.co.uk"],
          url: "https://electroplace.co.uk",
          sameAs: ["https://electroplace.co.uk"],
          description:
            "Electroplace — bright, honest electronics retail. Audio, laptops, smartphones, TV & video, cameras, smart home, gaming, wearables and accessories. Shipped from the United Kingdom.",
        }}
      />
