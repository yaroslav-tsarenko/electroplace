...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      ...
      `Shop ${category.name} products at Electroplace. Browse electronics, accessories, electrical materials and installation supplies.`,
    alternates: { canonical: `/${locale}/catalog/${category.slug}` },
    openGraph: {
      title: `${category.name} | Electroplace`,
      description:
        category.description ||
        `Shop ${category.name} products at Electroplace.`,
